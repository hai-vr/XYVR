...
public interface IAuthority
{
    ...
    /// such as "hai" all lowercase and the username is the in-app identifier, then the account returned here must contain the information that
    /// the authority actually presents (Hai), which may have different capitalization.
